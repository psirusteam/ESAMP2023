...
$$
\log(\hat{\sigma}^2) = \hat{\theta}_{dir} + n_{d}^2 + \sqrt{\hat{\theta}_{dir}\times n_{d}}
$$
...
El efecto diseño cambia entre categoría, por tanto, lo primero será definir el tamaño de muestra efectivo por categoría.
...
Crear una función que simplifica los cálculos. 
\scriptsize
```
functions {
...
## Indetificando los dominos no observados
